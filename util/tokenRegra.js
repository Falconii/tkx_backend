...
exports.token_Inclusao = async function(token) {
    try {
        const obj = await tokenSrv.getToken(
            token.id_empresa,
            token.id_usuario,
            token.token,
            token.tipo,
        ...
        if (obj != null) {
            throw new erroDB.UserException("Regra de negócio", [{
                tabela: "TOKEN",
                message: `"INCLUSÃO-TOKEN" Registro Já Existe Na Base De Dados.!`,
            }, ]);
        }
    } catch (err) {
        throw err;
...
exports.token_Alteracao = async function(token) {
    try {
        ...
        if (obj == null) {
            throw new erroDB.UserException("Regra de negócio", [{
                tabela: "TOKEN",
                message: `"ALTERAÇÃO-TOKEN" Registro Não Existe Na Base De Dados.!`,
            }, ]);
        }
    } catch (err) {
        throw err;
...
exports.token_Exclusao = async function(id_empresa, id_usuario, token, tipo) {
    try {
        ...
        if (obj == null) {
            throw new erroDB.UserException("Regra de negócio", [{
                tabela: "TOKEN",
                message: `"EXCLUSÃO-TOKEN" Registro Não Existe Na Base De Dados.!`,
            }, ]);
        }
    } catch (err) {
        throw err;
