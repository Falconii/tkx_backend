...
exports.entrega_Inclusao = async function(entrega) { 
	try { 
		const obj = await entregaSrv.getEntrega(entrega.id_empresa,entrega.id_evento,entrega.id);
		if (obj != null) { 
...
exports.entrega_Exclusao = async function(id_empresa,id_evento,id) { 
	try { 
		const obj = await entregaSrv.getEntrega(id_empresa,id_evento,id);
		if (obj == null) { 
