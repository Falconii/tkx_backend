select
                        ...
                        FROM participantes participante
                         ...
                         where participante.id_empresa = 1  and participante.id_evento = 4                      order by participante.id_empresa,participante.id_evento,participante.inscricao --limit 100 offset((1 -1) * 100)
